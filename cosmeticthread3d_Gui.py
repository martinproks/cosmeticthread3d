...
# **************************************************************
#
# Part version - temporary prepared for final implementation.
#   Right now there is a Type 5 of geometry, but it could be
#   easy changed according to final decision.
#
# **************************************************************
# **************************************************************
...
class ct3di_p_menu_command():
    ...
    def eA_ok(self):
        ...
        obj = ct3d_p.internal('CosmeticThread3DInternal',
                              ct3d_prms,
                              self.doc,
                              self.aPart)
...
class ct3de_p_menu_command():
    ...
    def eA_ok(self):
        ...
        ct3dGuiTools.fillParamsE(ct3d_prms,
                                 ...
                                 lst_threads)
        # Cosmetic thread creation
        obj = ct3d_p.external('CosmeticThread3DExternal',
                              ct3d_prms,
                              self.doc,
                              self.aPart)
        # Attachement apply from temporary object to cosmetic thread
